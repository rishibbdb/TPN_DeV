...
def get_neg_c_triple_gamma_llh(eval_network_doms_and_track_fn):
    ...
    def neg_c_triple_gamma_llh(track_direction,
        ...
        in_physics_range = delay_time > -1.0 * end_of_physics * sigma
        ...
        predicted_charge = jnp.sum(charges) / jnp.sum(predicted_charge) * predicted_charge
        ...
        noise_charge = jnp.array(0.05)
        noise_weight = noise_charge / (noise_charge + predicted_charge)
        physics_weights = 1.0 - noise_weight
