...
from lib.geo import cherenkov_cylinder_coordinates_v, cherenkov_cylinder_coordinates_w_rho_v
...
def get_eval_network_doms_and_track_altrho(eval_network_v_fn, dtype=jnp.float64):
    """
    network eval function (vectorized across doms)
    """
