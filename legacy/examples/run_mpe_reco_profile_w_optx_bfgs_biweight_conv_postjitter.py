...
from likelihood_mpe_biweight_conv_postjitter import get_neg_c_triple_gamma_llh
...
plt.legend()
plt.tight_layout()
plt.savefig(f"mpe_scan_ev_{event_index}_biweight_conv_postjitter.png", dpi=300)
