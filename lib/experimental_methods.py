...
def get_clean_pulses_fn(eval_network_doms_and_track_fn):
...
def get_clean_pulses_fn_v(eval_network_doms_and_track_fn):
    clean_pulses = get_clean_pulses_fn(eval_network_doms_and_track_fn)
