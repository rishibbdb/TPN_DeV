...
def start_process(argument_dict):
    script_path = '/home/storage/hans/jax_reco_gupta_corrections3/extract_data_from_i3files/convert_i3_tfrecord_realtime_alerts_filter_prepulse_NN_correction.py'
    cmd = ['python']
