...
def start_process(argument_dict):
    script_path = '/home/storage/hans/jax_reco_gupta_corrections2/extract_data_from_i3files/convert_i3_ftr_realtime_alerts.py'
    cmd = ['python']
    ...
    #outdir = "/home/storage2/hans/i3files/alerts/bfrv2_no_hole_ice_flat/ftr/charge/"

    indir = '/home/storage2/hans/i3files/lowE/bfrv2_no_holeice_flat/i3_nominal/'
    outdir = '/home/storage2/hans/i3files/lowE/bfrv2_no_holeice_flat/ftr/charge/'
