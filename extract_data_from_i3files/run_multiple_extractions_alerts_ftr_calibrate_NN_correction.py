...
def start_process(argument_dict):
    script_path = '/home/storage/hans/jax_reco_gupta_corrections3/extract_data_from_i3files/convert_i3_ftr_realtime_alerts_NN_correction.py'
    cmd = ['python']
    ...
    indir = "/home/storage2/hans/i3files/alerts/ftp-v1_flat/energy_loss_network_inputs/npe/i3/w_correction/"
    outdir = "/home/storage2/hans/i3files/alerts/ftp-v1_flat/energy_loss_network_inputs/npe/ftr/w_corrections/"
