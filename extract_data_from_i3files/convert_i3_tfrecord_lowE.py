...
parser.add_argument("-o", "--outdir", type=str,
                  default="/home/storage2/hans/i3files/lowE/tfrecord/",
                  dest="OUTDIR",
...
write_path = os.path.join(outdir, f"data_ds_{infile_base}_from_{file_index_start}_to_{file_index_end}_1st_pulse.tfrecord")
