...
def start_process(argument_dict):
    script_path = '/home/storage/hans/jax_reco_new/extract_data_from_i3files/convert_i3_tfrecord.py'
    cmd = ['python']
...
if __name__ == '__main__':
    ...
    arguments = []
    indir = f"/home/storage2/hans/i3files/21220/"
    outdir = f"/home/storage2/hans/i3files/21220/ftr/"
